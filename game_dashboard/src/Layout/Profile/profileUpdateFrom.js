...
import { useNavigate } from "react-router-dom";
 ...
 const AdminProfile = () => {
                                    ...
                                    <div className="card shadow mb-3">
                                        ...
                                        <div className="card-body">
                                            <form  onSubmit={(e) => handleSubmit(e)}>
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" htmlFor="first_name"><strong>Current Password</strong></label><input className="form-control" type="password" id="cur_pass" placeholder="Your current password"  maxLength="32" required /></div>
                                                    </div>
                                                    
                                                </div>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" htmlFor="username"><strong>New Password</strong></label><input className="form-control" type="password" id="new_pass" placeholder="New password" maxLength="32" required/></div>
                                                    </div>
                                                    
                                                </div>
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="mb-3"><label className="form-label" htmlFor="username"><strong>Confirm Password</strong></label><input className="form-control" type="password" id="confirm_pass" placeholder="Confirm password" maxLength="32" required/></div>
                                                    </div>
    ...
    function handleSubmit(e) {
        ...
        axios
          .put(
            "http://localhost:3001/adminManagement/changePassword/" + admin.Email+"/"+confirm_pass.value,
            adminUpdate
          )
          .then((res) => {
